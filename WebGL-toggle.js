(function(global) {
    // Entry를 찾을 때까지 계속 시도
    function initializeWhenEntryReady() {
        if (!global.Entry) {
            console.log("Entry를 찾는 중... 1초 후 재시도합니다.");
            setTimeout(initializeWhenEntryReady, 1000);
            return;
        }
        
        console.log("Entry 객체를 찾았습니다! 초기화를 시작합니다.");
        setupWebGLToggle();
    }
    ...
    // Entry를 찾을 때까지 초기화 시도 시작
    initializeWhenEntryReady();
})(window);